...
Fuente ejecutable de verdad para roles OS. El despliegue normaliza cada
DocType antes de enviarlo a Frappe para evitar drift de permisos.
"""
...
MATRIX: dict[str, dict[str, str]] = {
    ...
    "OS Process Action": {"OS Admin":"RWCD","OS Architect":"RWC","OS Publisher":"RW","OS AI Supervisor":"R","OS Manager":"R","OS Operator":"R","OS Auditor":"R","OS Viewer":"R"},
    ...
    "OS Document Link": {"OS Admin":"RWCD","OS Architect":"R","OS Publisher":"R","OS AI Supervisor":"R","OS Manager":"R","OS Operator":"R","OS Auditor":"R","OS Viewer":"R"},
...
SYSTEM_MANAGER = {"role":"System Manager","read":1,"write":1,"create":1,"delete":1,"report":1,"export":1}
